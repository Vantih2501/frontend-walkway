      ...
      <Card
        ...
        <div className="container mx-auto">
          <div className="flex">
            ...
            />
            <a href="../BidHistory" className="backDetail"><Button type="primary">Back</Button></a>
          </div>
          ...
          <div className="list container mx-auto">
              ...
              <hr className="hrOrder" />
              <Row className="ml-10 mt-3">
                <Col><p className="text-base font-semibold">REFUND</p></Col>
                <Col><p className="text-base font-semibold reffDetail">Rp 2,524,000</p></Col>
              </Row>
