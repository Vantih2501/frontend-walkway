    ...
    <div>
      <Card className="cardI">
        <div className="flex mx-10">
          ...
          <Image src="/product1.png" alt="product" width={220}></Image>
        ...
        <div className="flex">
          ...
          <RightOutlined style={{ marginLeft: "460px", fontSize: "20px" }} />
        </div>
      </Card>
      ...
      >
        ...
        >
          ...
          <Form.Item>
            <Button block type="primary" htmlType="submit" className="svaddress">
              Save Address
            </Button>
          </Form.Item>
        </Form>
